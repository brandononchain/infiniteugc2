  ...
  return (
    <>
      ...
      <textarea
        ...
        placeholder="Write your script or let CoPilot generate one..."
        rows={8}
      ...
      {data.generatedContent && (
        <div className="p-2.5 rounded-lg bg-emerald-500/5 border border-emerald-500/12">
          <p className="text-[9px] font-medium text-emerald-400/60 mb-1">CoPilot Generated</p>
          <p className="text-[11px] text-white/40 leading-relaxed">{data.generatedContent}</p>
        </div>
      )}
    </>
  );
