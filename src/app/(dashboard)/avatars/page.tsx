      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-10 py-8">
        {loading ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {avatars.map((avatar) => (
              <div key={avatar.id} className="bg-white rounded-xl overflow-hidden brutal-card group">
                ...
                <div className="p-3">
                  <p className="text-xs font-bold text-zinc-900 truncate">{avatar.name}</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl border border-zinc-200">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-sm font-bold text-zinc-950">Upload Avatar</h2>
            ...
            <div className="space-y-4">
              <div>
                <label className="text-[11px] font-semibold text-zinc-700 mb-1 block">Avatar Name</label>
                <input
                  type="text"
                  value={avatarName}
              ...
              <div>
                <label className="text-[11px] font-semibold text-zinc-700 mb-1 block">Avatar Image</label>
                ...
                {imagePreview ? (
                  ...
                  >
                    ...
                    <p className="text-[11px] font-semibold text-accent-600">Upload image</p>
              ...
              <div className="relative">
                <label className="text-[11px] font-semibold text-zinc-700 mb-1 block">Voice (Optional)</label>
                <button
                  ...
                  <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-zinc-200 rounded-lg shadow-lg z-20 overflow-hidden max-h-40 overflow-y-auto">
                    ...
                    {voices.map((v) => (
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 text-sm hover:bg-zinc-50 ${selectedVoiceId === v.id ? "bg-accent-50 font-semibold" : "text-zinc-700"}`}
                      >
                        {v.name}
                      </button>
                    ))}
