        ...
        <div className="max-w-2xl mx-auto px-6 lg:px-8 py-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full brutal-input bg-[#1e1e22] px-3 py-2 text-xs text-zinc-200 placeholder:text-zinc-500 font-mono transition-all resize-none"
            />
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full brutal-input bg-[#1e1e22] px-3 py-2 text-sm text-zinc-200 placeholder:text-zinc-500 transition-all resize-none"
            />
          </div>
